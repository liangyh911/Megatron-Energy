...
class ParallelMLP(MegatronModule):
    ...
    def forward(self, hidden_states):
        ...
        #     print("--dense_h_to_4h time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--dense_h_to_4h time: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--activation func: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--activation func: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--dense_4h_to_h time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--dense_4h_to_h time: " + str(excu_time) + "\n")
        # f.close()
...
class CoreAttention(MegatronModule):
    ...
    def forward(self, query_layer, key_layer,
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--CoreAttn 1: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--CoreAttn 1: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--Q*K^T time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--Q*K^T time: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--softmax_and_mask time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--softmax_and_mask time: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--attn_dropout: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--attn_dropout: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--CoreAttn 2: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--CoreAttn 2: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--AP*V time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--AP*V time: " + str(excu_time) + "\n")
        # f.close()
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--CoreAttn 3: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--CoreAttn 3: " + str(excu_time) + "\n")
        # f.close()
...
class ParallelAttention(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if self.attention_type == AttnType.self_attn:
            ...
            # excu_time = time.perf_counter() - start
            # if torch.distributed.get_rank() == 0:
            #     print("--QKV time: ", excu_time)
            # I = torch.distributed.get_rank()
            # f = open("./output/profile/"+str(I)+".txt", 'a')
            # f.write("--QKV time: " + str(excu_time) + "\n")
            # f.close()
        ...
        if self.enable_ds_sequence_parallel:
            ...
            if self.use_flash_attn:
                ...
                if self.checkpoint_core_attention:
                    ...
                    # excu_time = time.perf_counter() - start
                    # if torch.distributed.get_rank() == 0:
                    #     print("--core attn time: ", excu_time)
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("--attn output time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("--attn output time: " + str(excu_time) + "\n")
        # f.close()
...
class ParallelTransformerLayer(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask=None,
        ...
        # excu_time = time.perf_counter() - start
        # if torch.distributed.get_rank() == 0:
        #     print("-----self attn time: ", excu_time)
        # I = torch.distributed.get_rank()
        # f = open("./output/profile/"+str(I)+".txt", 'a')
        # f.write("-----self attn time: " + str(excu_time) + "\n")
        # f.close()
        ...
        if self.num_experts == 1:
            ...
            # excu_time = time.perf_counter() - start
            # if torch.distributed.get_rank() == 0:
            #     print("-----mlp time: ", excu_time)
            # I = torch.distributed.get_rank()
            # f = open("./output/profile/"+str(I)+".txt", 'a')
            # f.write("-----mlp time: " + str(excu_time) + "\n")
            # f.close()
        else:
...
def get_num_experts_per_layer(num_experts: list, num_layers: int, expert_interval: int, offset: int = 0) -> list:
    ...
    for i in range(num_layers):
        ...
        # layer_num = i + offset
        # print("offset: ", offset, "num_layers: ", num_layers, "num_exp: ", (num_experts), "interval: ", \
        #         expert_interval, "idx: ", ((layer_num-1) // expert_interval))
...
class ParallelTransformer(MegatronModule):
    ...
    def __init__(self, config,
        ...
        # print("Total layer: ", args.num_layers)
        self.layer_type = layer_type
        ...
        if config.virtual_pipeline_model_parallel_size is not None:
            ...
            if args.model_type == ModelType.encoder_and_decoder and \
                ...
                print("ps: ", parallel_state.get_pipeline_model_parallel_rank(),"nl: ", self.num_layers)
